...
import numpy as np
from reinforcement_learning.marl.constants import AGENT_ACTIONS, COORDINATOR, COORDINATOR_ACTIONS, COORDINATOR_LABELS, HOST_LABELS
...
def marl_attack_detect_main(config, env: NetworkEnvMarlAttackDetect):
